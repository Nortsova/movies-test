...
import {
  addCommentByMovieIdToFirebase,
  addCommentByIdsToFirebase,
  addCommentIdToFirebase,
  downloadCommentsFromFirebase,
  initFirebase
} from "../api/firebase";
...
function* loadCommentsSaga() {
  const data = yield call(downloadCommentsFromFirebase);
